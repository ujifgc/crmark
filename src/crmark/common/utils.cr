module MarkdownIt
  module Common
    module Utils
      ...
      UNESCAPE_ALL_RE = Regex.new(UNESCAPE_MD_RE.source + "|" + ENTITY_RE.source, Regex::Options::IGNORE_CASE)
      ...
      #------------------------------------------------------------------------------
      def escapeHtml(str)
        if HTML_ESCAPE_TEST_RE.match(str)
